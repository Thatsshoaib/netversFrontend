              ...
              {[
                {
                  ...
                  icon: <FaStar className="text-yellow-900 text-3xl" />,
                ...
                },
                {
                  ...
                  icon: <FaMedal className="text-orange-900 text-3xl" />,
                  details: "Includes basic bonuses.",
                },
                {
                  planId: 3,
                  name: "Silver",
                  ...
                  icon: <FaMedal className="text-gray-900 text-3xl" />,
                  details: "Unlocks more commission levels.",
                },
                {
                  planId: 4,
                  name: "Gold",
                  ...
                  icon: <FaTrophy className="text-yellow-900 text-3xl" />,
                  details: "Most popular plan!",
                },
                {
                  planId: 5,
                  name: "Diamond",
                  ...
                  icon: <FaGem className="text-blue-900 text-3xl" />,
                  details: "Get high-tier payouts.",
                },
                {
                  planId: 6,
                  name: "Platinum",
                  ...
                  details: "Top-tier unlimited plan.",
                },
              ].map((plan, idx) => (
                <div key={idx} className="px-2">
                  ...
                  <div className="relative p-[2px] rounded-2xl bg-gradient-to-br from-white via-transparent to-[rgba(255,255,255,0.2)] hover:from-blue-400 hover:to-purple-600 transition-all duration-300 shadow-xl group">
                    ...
                    >
                      ...
                      {/* ✅ CTA Button */}
                      <button
                        className="mt-3 bg-white text-black font-medium px-4 py-2 rounded-full hover:bg-gray-200 transition duration-300"
                        onClick={() =>
                          navigate(`/tree/${userId}/${plan.planId}`)
                        }
                      >
                        Select Plan
                      </button>
